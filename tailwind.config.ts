    ...
    extend: {
      ...
      colors: {
        ...
        card: {
          ...
          "foreground-border": "hsl(var(--card-foreground-border))",
        ...
        destructive: {
          ...
          "foreground-border": "hsl(var(--destructive-foreground-border))",
          faded: "hsl(var(--destructive-faded))",
        },
